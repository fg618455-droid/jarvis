...
| `src/jarvis/providers/providers.spec.md` | Run-oriented subscription provider interface, shared data types and normalised events | Fail closed; evidence-backed models and capabilities; unsupported operations are explicit; quota is terminal |
